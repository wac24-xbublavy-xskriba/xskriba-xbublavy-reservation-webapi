const mongoHost = process.env.RESERVATION_API_MONGODB_HOST;
const mongoPort = process.env.RESERVATION_API_MONGODB_PORT;

const mongoUser = process.env.RESERVATION_API_MONGODB_USERNAME;
const mongoPassword = process.env.RESERVATION_API_MONGODB_PASSWORD;

const database = process.env.RESERVATION_API_MONGODB_DATABASE;
const collection = process.env.RESERVATION_API_MONGODB_COLLECTION;
